  ...
  return (
    <main className="stage-bg min-h-screen px-4 py-6 sm:px-10 sm:py-10">
      ...
      <div className="mx-auto mt-14 max-w-4xl space-y-6">
        ...
        <p className="text-[#4a425d]">Consider financial stability, growth opportunities, and long-term goals.</p>

        <p><strong className="text-[#1f1a2d]">Is it risky to quit without another job lined up?</strong></p>
        <p className="text-[#4a425d]">Yes, unless you have sufficient savings or a clear alternative plan.</p>

        <p><strong className="text-[#1f1a2d]">Should I quit if I’m unhappy at work?</strong></p>
        <p className="text-[#4a425d]">Unhappiness alone may not justify quitting without a strategy.</p>

        <p><strong className="text-[#1f1a2d]">How much savings should I have before quitting?</strong></p>
        <p className="text-[#4a425d]">Many experts recommend 3–6 months of living expenses.</p>

        <p><strong className="text-[#1f1a2d]">Can quitting a job hurt my career?</strong></p>
        <p className="text-[#4a425d]">It depends on timing and how you explain the decision.</p>

        <p><strong className="text-[#1f1a2d]">What are signs I should stay?</strong></p>
        <p className="text-[#4a425d]">If the role still offers growth and aligns with your goals, reconsider leaving.</p>
